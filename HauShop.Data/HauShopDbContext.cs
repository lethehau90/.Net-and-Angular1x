...
namespace HauShop.Data
{
    public class HauShopDbContext: IdentityDbContext<ApplicationUser>
    {
        public HauShopDbContext(): base("HauShopConnection")
        {
        ...
        public static HauShopDbContext Create()
        {
            return new HauShopDbContext();
        }
