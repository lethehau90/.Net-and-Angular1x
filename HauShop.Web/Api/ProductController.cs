...
namespace HauShop.Web.Api
{
    ...
    public class ProductController : ApiControllerBase
    {
        ...
        [Route("getall")]
        [HttpGet]
        public HttpResponseMessage GetAll(HttpRequestMessage request, string keyword, int category, int page, int pageSize = 20)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                if (category != 0)
                {
                    model = model.Where(x => x.CategoryID.Equals(category));
                }
                ...
                var responseData = Mapper.Map<List<ProductViewModel>>(query.ToList());
