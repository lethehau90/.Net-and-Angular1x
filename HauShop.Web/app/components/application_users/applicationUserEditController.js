(function (app) {
    ...
    applicationUserEditController.$inject = ['$scope', 'apiService', 'notificationService', '$location', '$stateParams', '$filter', 'commonService'];

    function applicationUserEditController($scope, apiService, notificationService, $location, $stateParams, $filter, commonService) {
        $scope.account = {}
        ...
        function updateAccount() {
            ...
            $scope.account.BirthDay = commonService.convertDateString($scope.account.BirthDay)
        ...
        function loadDetail() {
            ...
            function (result) {
                ...
                $scope.account.BirthDay = $filter('date')(result.data.BirthDay, 'dd/MM/yyyy')
            },
            function (result) {
