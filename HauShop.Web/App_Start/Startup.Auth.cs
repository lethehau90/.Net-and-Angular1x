...
[assembly: OwinStartup(typeof(HauShop.Web.App_Start.Startup))]

namespace HauShop.Web.App_Start
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(HauShopDbContext.Create);
            ...
            app.UseFacebookAuthentication(
               appId: "135602390315309",
               appSecret: "da9fb2258fa5a0649bf8692df4e8decf");

            app.UseGoogleAuthentication(new GoogleOAuth2AuthenticationOptions()
            {
                ClientId = "768032409365-plt6bs5tolfrbtbl10asss3nca076bjo.apps.googleusercontent.com",
                ClientSecret = "lIR6zaq_U_IulQ4RNU9yXU9a"
            });
        }
        ...
        {
            var userStore = new UserStore<ApplicationUser>(context.Get<HauShopDbContext>());
